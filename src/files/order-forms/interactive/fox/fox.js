...
function SetColor(item, color)
{
  ...
  {
    var temp = GetValue('leading_edge');
  }
  if (item == 'trailing_edge')
  {
    var temp = GetValue('trailing_edge');
    if (temp == 'Smoke - Contender APEN06' || temp == 'Clear - Contender APEN06')
    {
      document.getElementById('trailing_edge_reinforcement').selectedIndex = 0;
      document.getElementById('trailing_edge_reinforcement').disabled = 1;
    }
    else
    {
      document.getElementById('trailing_edge_reinforcement').disabled = 0;
      var idx = document.getElementById('trailing_edge').selectedIndex;
      document.getElementById('trailing_edge_reinforcement').selectedIndex = idx - 1;
      svgdom.getElementById('trailing_edge_reinforcement').style.fill = color;
    }
  }
  if (item != 'letters')
  {
