...
function getLegName($option){  //lookup material name for option in materials array
	global $materials, $sbmopt;
	$matid = $sbmopt["$option"];
	$nameLeg = $materials["$matid"]['namelegend'];
	return $nameLeg;
}
...
$headerText = "Combat " . $sbmopt["wing_size"] . $sbmopt["opt_wingversion"];

if ($sbmopt["opt_order"] == "sail"){$headerText .= " - sail only";}
...
$pdf->SetTitle($headerText . ' order form');
$pdf->SetSubject($headerText);
$pdf->SetKeywords('Aeros, Order form, ' . $headerText);
...
//A logo
$a_logo_svg = '<svg id="a_logo" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="80px" height="80px" viewBox="0 0 80 80" enable-background="new 0 0 80 80" xml:space="preserve"><g><path fill="#000000" d="M35.25,34.98c-2.02,1.38-4.05,2.95-6.53,4.97l6.53-9.94l3.13-4.6l3.5,5.8 C39.49,32.5,37.37,33.6,35.25,34.98z M0,70.97h9.94c7.73-11.78,16.02-21.17,25.31-29c2.95-2.49,5.89-4.79,9.02-6.9l3.86,6.17 c-4.41,3.13-8.83,7-12.88,11.23c-5.06,5.43-9.62,11.6-13.3,18.5h8.88c1.47-3.22,2.95-5.89,4.42-8.38c4.23-6.72,8.84-11.51,15-17.4 l4.05,6.35c-5.34,5.25-9.67,11.32-12.7,19.33h7.37c1.66-5.89,4.69-11.59,7.91-15.56L66,70.88h10.03l-13.44-22 c4.69-4.05,10.95-7.36,17.3-9.94c-8.38,1.84-13.62,3.96-19.05,7.37l-3.96-6.17c4.69-3.5,11.78-7.64,17.03-10.21 c-7.09,1.84-13.25,4.14-18.77,6.99l-4.05-6.44c5.16-2.95,10.86-6.45,17.31-9.21c-7.46,1.57-12.8,3.5-18.96,6.26L38.2,8.93L0,70.97"/></g></svg>';
...
//speedbat & uprights
if( !array_key_exists("speedbar",$sbmopt)){$sbmopt['speedbar']='SPEEDBARCARBON';}
if( !array_key_exists("uprights",$sbmopt)){$sbmopt['uprights']='UPRIGHTSSLIPSTRBLACK';}
...
//dashed lines 
$dashedline='';
if ($sbmopt['top_surface'] == 'ODL06WHITEUV'){//if white top surface
    $dashedline='stroke-dasharray:10,5;';
}

$svgLegend = '
<g id="g_leg_ribs_tv">
        <circle cx="725.02" cy="104.171" r="1.937"/>
        <path d="M725.02,104.171l40.269,89.551l111.136,0" style="fill:none;stroke:#000;'.$dashedline.'stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
        <text id="t_leg_ribs_tv" x="780px" y="190.232px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("ribs").'
        </text>
        <text id="d_leg_ribs_tv" x="780px" y="206px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Ribs</text>
    </g>
    <g id="g_leg_battens_tv">
        <circle cx="585.825" cy="83.096" r="1.937"/>
        <path d="M585.825,83.096l12.826,92.684l111.136,0" style="fill:none;stroke:#000;'.$dashedline.'stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
        <text id="t_leg_battens_tv" x="606.554px" y="172.29px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("battens").'
        </text>
        <text id="d_leg_battens_tv" x="606.554px" y="188px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Batten Pockets</text>
    </g>
    <g id="g_leg_TS_tv">
        <circle cx="586.294" cy="67.523" r="1.937"/>
        <path d="M586.294,67.523l40.5,-40.423l120,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
        <text id="t_leg_TS_tv" x="630px" y="23.102px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("top_surface").'
        </text>
        <text id="d_leg_TS_tv" x="630px" y="39.102px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Top Surface</text>
    </g>
    <g id="g_leg_LE_tv">
        <circle cx="744.733" cy="83.281" r="1.937"/>
        <path d="M744.733,83.281l25.422,-21.431l111.136,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
        <text id="t_leg_LE_tv" x="773px" y="58.36px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("leading_edge").'
        </text>
        <text id="d_leg_LE_tv" x="773px" y="74.36px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Leading Edge</text>
    </g>
    <g id="g_leg_LE_bv">
        <circle cx="384.215" cy="252.154" r="1.937"/>
        <path d="M384.215,252.154l25.422,-21.43l111.136,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
        <text id="t_leg_LE_bv" x="414px" y="227.233px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("leading_edge").'
        </text>
        <text id="d_leg_LE_bv" x="414px" y="243.233px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Leading Edge</text>
    </g>
';

if ($sbmopt['bottom_layout'] == 'Standard'){//Standard bottom legend
    $svgLegend .= '<g id="standard">
        <g id="g_leg_RL_bv">
            <circle cx="681.057" cy="377.825" r="1.937"/>
            <path d="M681.057,377.825l90,-38l100,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_RL_bv" x="776.287px" y="336px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("rear_line").'
            </text>
            <text id="d_leg_RL_bv" x="776.287px" y="352px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Rear Line</text>
        </g>
        <g id="g_leg_ML_bv">
            <circle cx="636.704" cy="363.779" r="1.937"/>
            <path d="M636.704,363.779l32,-50l111.136,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_ML_bv" x="676.561px" y="310px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("middle_line").'
            </text>
            <text id="d_leg_ML_bv" x="676.561px" y="326px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Middle Line</text>
        </g>
        <g id="g_leg_BS_bv">
            <circle cx="532" cy="321" r="1.937"/>
            <path d="M532,321l40,-40l111,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_BS_bv" x="579px" y="277px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("bottom_surface_standard").'
            </text>
            <text id="d_leg_BS_bv" x="579px" y="293px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Bottom Surface</text>
        </g>
    </g>';
}
else{//Technora bottom legend
    $svgLegend .='<g id="Technora">
        <g id="g_leg_LF_bv">
            <circle cx="475.85" cy="292.487" r="1.937"/>
            <path d="M475.85,292.487l25.422,-30l100,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_LF_bv" x="510px" y="259.566px" style="font-family:'."Arial-ItalicMT".',' ."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("line_front").'
            </text>
            <text id="d_leg_LF_bv" x="510px" y="275.566px" style="font-family:'."Arial-ItalicMT".',' ."Arial".', sans-serif;font-style:italic;font-size:12px;">Front Stripe</text>
        </g>
        <g id="g_leg_BS_bv">
            <circle cx="532.802" cy="321.025" r="1.937"/>
            <path d="M532.802,321.025l50,-33l100,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_BS_bv" x="587px" y="285px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("bottom_surface_odl").'
            </text>
            <text id="d_leg_BS_bv" x="587px" y="300px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Bottom Surface</text>
        </g>
        <g id="g_leg_LR1_bv">
            <circle cx="629.639" cy="364.465" r="1.937"/>
            <path d="M629.639,364.465l50,-48l100.136,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_LR1_bv" x="684px" y="313px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("line_rear_1").'
            </text>
            <text id="d_leg_LR1_bv" x="684px" y="329px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Stripe Rear 1</text>
        </g>
        <g id="g_leg_LR2_bv">
            <circle cx="712.334" cy="385.636" r="1.937"/>
            <path d="M712.334,385.636l52,-45l100,0" style="fill:none;stroke:#000;stroke-width:0.5px;stroke-linecap:round;stroke-miterlimit:1.5;"/>
            <text id="t_leg_LR2_bv" x="769px" y="337px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:14px;">'.getLegName("line_rear_2").'
            </text>
            <text id="d_leg_LR2_bv" x="769px" y="353px" style="font-family:'."Arial-ItalicMT".', '."Arial".', sans-serif;font-style:italic;font-size:12px;">Stripe Rear 2</text>
        </g>
    </g>';
}
...
<svg viewBox="0 0 910 430" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" preserveAspectRatio="xMinYMid meet">
    <g id="bottom_view">
        ...
        <path id="uprights_bv" d="M247.765,289.395l0.482,-3.731c1.034,-0.54 3.935,1.639 5.517,3.253l-15.837,126.364l-6.117,-2.414l15.279,-118.24l-122.437,112.512l-4.874,-4.622l126.282,-114.987l1.705,1.865Z" style="fill:' . getColor("uprights") . ';fill-opacity: ' . getOpac("uprights") . ';stroke:#000;stroke-width:0.4px;stroke-miterlimit:1;"/>
        ...
        <path id="leading_edge_bv" d="M823.886,385.191c0.087,-1.44 0.713,-3.073 1.789,-3.509c-1.496,-0.759 -7.743,-3.63 -12.979,-5.345c-9.821,-3.221 -47.755,-15.7 -54.771,-17.884c-8.211,-2.875 -79.394,-25.289 -89.805,-28.368c-81.311,-24.047 -157.286,-47.184 -184.545,-54.885c-25.795,-7.29 -41.158,-11.241 -92.451,-26.32c-32.108,-8.624 -51.862,-13.891 -92.942,-25.715c-19.825,-5.706 -39.724,-11.151 -59.586,-16.726c-17.732,-5.063 -35.384,-10.401 -53.113,-15.462l-0.172,-0.392c-3.384,-1.085 -6.383,-2.065 -10.557,-2.948c-3.863,-0.817 -6.122,-1.434 -10.781,-1.84c-0.622,-0.056 -3.23,-0.191 -4.715,0.613c-1.358,0.734 -2.328,1.908 -2.733,2.382c-2.287,2.679 -5.316,6.552 -8.106,10.407c-30.815,30.055 -61.556,58.393 -86.998,83.937c-11.654,11.701 -43.805,43.993 -54.273,66.776c-0.056,0.122 -0.077,0.235 -0.091,0.303c-0.141,0.631 6.486,4.004 6.485,4.004c8.543,-11.363 16.933,-21.605 23.8,-29.587c3.693,-4.295 10.763,-12.383 20.169,-22.234c6.766,-7.086 11.587,-11.78 19.672,-19.655c6.59,-6.415 9.664,-9.274 43.496,-41.266l0.025,-0.024c4.582,-4.333 34.072,-31.096 37.788,-34.639c4.143,2.437 8.278,4.215 8.278,4.215l5.95,-0.5l5.001,-0.201l0.853,-6.21c0,0 100.144,29.118 147.821,42.86c75.765,21.839 97.679,27.944 157.958,45.609c7.799,2.286 15.78,4.645 25.673,7.591c95.277,28.36 115.399,34.641 185.535,54.617c56.816,16.184 128.81,35.759 128.81,35.759c0,0 -0.626,-3.046 -0.485,-5.363" style="fill:' . getColor("leading_edge") . ';fill-opacity: ' . getOpac("leading_edge") . ';stroke:#000;stroke-width:0.5px;stroke-miterlimit:1;"/>
    </g>
    <g id="top_view">
...
$pdf->ImageSVG('@' . $wingsvg, $x=docMarginLeft + 30, $y=$headerlineY+1.5, $w=210-docMarginLeft-docMarginRight, $h=85, $link='', $align='N', $palign='C', $border=0, $fitonpage=false);
...
//Wing Size
//$pdf->MultiCell($fcolw, 0, "Wing Size", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
//$pdf->MultiCell($scolw, 0, $sbmopt["wing_size"], 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
//
//$pdf->ln($ln_mm);
...
if ($sbmopt['bottom_layout'] == 'Standard'){//Standard Layout
    //Bottom surface layout
    $pdf->MultiCell($fcolw, 0, "Bottom Layout", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, $sbmopt['bottom_layout'], 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Bottom surface
    $pdf->MultiCell($fcolw, 0, "Bottom Surface", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, getFullName("bottom_surface_standard"), 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Middle line
    $pdf->MultiCell($fcolw, 0, "Middle Line", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
...
else{//Transparent layout
    //Bottom surface layout
    $pdf->MultiCell($fcolw, 0, "Bottom Layout", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, $sbmopt['bottom_layout'], 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Stripe Front
    $pdf->MultiCell($fcolw, 0, "Stripe Front", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, getFullName("line_front"), 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Bottom surface
    $pdf->MultiCell($fcolw, 0, "Bottom Surface", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, getFullName("bottom_surface_odl"), 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Stripe Rear 1
    $pdf->MultiCell($fcolw, 0, "Stripe Rear 1", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, getFullName("line_rear_1"), 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
    
    //Stripe Rear 2
    $pdf->MultiCell($fcolw, 0, "Stripe Rear 2", 0, 'L', 0, 0, 20, '', true, 0, false, true, 40, 'T'); // left cell
    $pdf->MultiCell($scolw, 0, getFullName("line_rear_2"), 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
}
...
//Letters
$lettersValue = "";
if(array_key_exists("letters",$sbmopt) && $sbmopt["letters"] != "no_letters"){
	$lettersValue=getFullName("letters");
	if (array_key_exists("l_type",$sbmopt) && $sbmopt["l_type"] == "1"){$lettersValue .= ', Outlined';}
	if (array_key_exists("l_size",$sbmopt) && $sbmopt["l_size"] == "big")
		{$lettersValue .= ', Big';} else {$lettersValue .= ', Small';}
    if (array_key_exists("l_font",$sbmopt) && $sbmopt["l_font"] == "lat")
		{$lettersValue .= ', Latin';} else {$lettersValue .= ', Cyrillic';}
}
else{$lettersValue = 'No';}
...
if ($sbmopt["opt_order"] == "wing") {
    ...
    //Uprights
	$pdf->MultiCell($wrWidth / 2, 0, "Uprights: ".getFullName("uprights"), 0, 'L', 0, 0, '', '', true, 0, false, true, 40, 'T'); 
		
	//Speedbar
	$pdf->MultiCell($wrWidth / 2, 0, "Speedbar: ".getFullName("speedbar"), 0, 'L', 0, 1, '', '', true, 0, false, true, 40, 'T');
    
    //Hang Connection
	$pdf->MultiCell($wrWidth / 2, 0, "Hang Connection: ".$sbmopt["hang_connection"], 0, 'L', 0, 0, '', '', true, 0, false, true, 40, 'T');
		
	//Speedbar Position
	$pdf->MultiCell($wrWidth / 2, 0, "Speedbar Position: ".$sbmopt["speedbar_pos"], 0, 'L', 0, 1, '', '', true, 0, false, true, 40, 'T');
    
    //CG
    if (array_key_exists("mcg",$sbmopt)){$textMCG = "Yes";}else{$textMCG = 'No';}
	$pdf->MultiCell($wrWidth / 2, 0, "Movable CG: ".$textMCG, 0, 'L', 0, 0, '', '', true, 0, false, true, 40, 'T');
		
	//LE Carbon Inserts
    if (array_key_exists("leinserts",$sbmopt)){$textLEInsterts = "Yes";}else{$textLEInsterts = 'No';}
	$pdf->MultiCell($wrWidth / 2, 0, "LE Carbon inserts: ".$textLEInsterts, 0, 'L', 0, 1, '', '', true, 0, false, true, 40, 'T');
	
    $pdf->ln($ln_mm);
    
    //Spare Parts
    if ($sbmopt["spare_uprights"] ==''){$sbmopt["spare_uprights"] = '0';}
	if (array_key_exists("spare_speedbar_carbon",$sbmopt)){$spareSpeedBarC = $sbmopt["spare_speedbar_carbon"];}else{$spareSpeedBarC = 'No';}
	if (array_key_exists("spae_speedbar_alu_round",$sbmopt)){$spareSpeedAluR = $sbmopt["spae_speedbar_alu_round"];}else{$spareSpeedAluR = 'No';}
	if (array_key_exists("spare_speedbar_alu_profile",$sbmopt)){$spareSpeedBarAluP = $sbmopt["spare_speedbar_alu_profile"];}else{$spareSpeedBarAluP = 'No';}
	$pdf->Write(0, 'SPARE PARTS' . "\n", '', 0, 'L', true, 0, false, false, 0);
	$pdf->MultiCell($wrWidth / 2, 0, 'Uprights: ' . $sbmopt["spare_uprights"], 0, 'L', 0, 0, '', '', true, 0, false, true, 40, 'T');
	$pdf->MultiCell($wrWidth / 2, 0, 'Alu Profile Speedbar: ' . $spareSpeedBarAluP, 0, 'L', 0, 1, '', '', true, 0, false, true, 40, 'T');
    $pdf->MultiCell($wrWidth / 2, 0, 'Carbon Speedbar: ' . $spareSpeedBarC, 0, 'L', 0, 0, '', '', true, 0, false, true, 40, 'T');
	$pdf->MultiCell($wrWidth / 2, 0, 'Alu Round Speedbar: ' . $spareSpeedAluR, 0, 'L', 0, 1, '', '', true, 0, false, true, 40, 'T');
...
$pdf->MultiCell($scolw, 0, "Order reference: " . $sbmopt["cust_ref"], 0, 'L', 0, 1, 65 , '', true, 0, false, true, 40, 'T'); // right cell
...
$pdf->Output($headerText . '_order_form.pdf', 'I');
